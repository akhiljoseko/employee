...
class CalendarDatePicker extends StatefulWidget {
  ...
  CalendarDatePicker({
    ...
    assert(
      !(this.initialDate?.isBefore(this.firstDate) ?? false),
      'initialDate ${this.initialDate} must be on or after firstDate ${this.firstDate}.',
    );
    assert(
      !(this.initialDate?.isAfter(this.lastDate) ?? false),
...
class _CalendarDatePickerState extends State<CalendarDatePicker> {
  ...
  void initState() {
    ...
    _currentDisplayedMonthDate = widget.initialDate == null
...
class _MonthPicker extends StatefulWidget {
  ...
  _MonthPicker({
    ...
    required this.onPickerModeToggled,
  })  : assert(!firstDate.isAfter(lastDate)),
        assert(!(selectedDate?.isBefore(firstDate) ?? false)),
        assert(!(selectedDate?.isAfter(lastDate) ?? false));
  ...
  final VoidCallback onPickerModeToggled;
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                // const Spacer(),
                IconButton(
                  icon: SvgPicture.asset(AppIcons.drop_down_arrow_left),
                  color: controlColor,
                ...
                _DatePickerModeToggleButton(
                    ...
                    onTitlePressed: widget.onPickerModeToggled),
                IconButton(
                  icon: SvgPicture.asset(AppIcons.drop_down_arrow_right),
                  color: controlColor,
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? weekdayStyle = Theme.of(context)
            .textTheme
            .labelLarge
            ?.copyWith(color: AppColors.calendarDayBlack) ??
        datePickerTheme.weekdayStyle ??
        defaults.weekdayStyle;
